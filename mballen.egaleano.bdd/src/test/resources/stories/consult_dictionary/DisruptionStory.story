...
Scenario: Getting data about disrupted streets in London
Given I want to know the streets that are disrupted today
When I select todays date
Then I should get tje streets that are disrupted today
...
Then I should get tje streets that were disrupted last monday